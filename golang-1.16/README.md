...
vulnerabilities in your Golang projects on Golang 1.16. This Action is based on the [Snyk CLI][cli-gh] and you can use [all of its options and capabilities][cli-ref] with the `args`.
  ...
  security:
    ...
    steps:
      ...
      - name: Run Snyk to check for vulnerabilities
        uses: snyk/actions/golang-1.16@master
        env:
